...
## Objectives
-Calculate oxidation and reduction currents against potential.
-Calculate the area of curve
-Calculate potential difference between the oxidation and reduction peak
-Calculate capacity
-Obtain publishing quality graphs
...
## How to use
Load your data and just change parameters according to the loaded data and run the code.
